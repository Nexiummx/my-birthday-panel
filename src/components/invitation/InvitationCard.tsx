 ...
 *
 * El marco ilustrado es exclusivo del tema Bosque: es un PNG de jardín de hadas
 * y en Vaqueros o Barbie desentonaría. Los demás temas se apoyan en la textura
 * de papel, que sí sigue la paleta del tema.
 */
export function InvitationCard({
  ...
  const { invitationImage, theme } = invitation.event;
  const illustrated = theme === "BOSQUE";
  ...
  return (
    <article
      className={[
        ...
        illustrated ? "" : "paper-texture paper-grain",
      ].join(" ")}
    >
      {illustrated && (
        <>
